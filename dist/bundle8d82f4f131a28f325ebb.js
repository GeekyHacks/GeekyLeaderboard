...
var gameUrl = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/9W40RRKEzdVGseFky5fH/scores/';
...
var uList = document.querySelector('.recentScores');
...
var renderList = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(listData) {
    var uList, response, sortedDataList, li, i, objects;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 7:
          ...
          for (i = 0; i < sortedDataList.length; i++) {
...
/******/ })()
;
//# sourceMappingURL=bundle8d82f4f131a28f325ebb.js.map